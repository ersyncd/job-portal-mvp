  ...
  return (
    <main className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Link href="/" className="text-gray-500 hover:text-gray-700 text-sm mb-8 inline-flex items-center font-medium transition-colors">
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
            ...
            <div className="p-8 bg-gray-50 flex flex-col gap-6 border-l border-gray-100">
              ...
              <a href={`mailto:hr@${job.companyName.replace(/\s+/g, '').toLowerCase()}.com`}
                target="_blank"
